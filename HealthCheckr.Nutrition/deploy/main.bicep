...
resource nutritionQueue 'Microsoft.ServiceBus/namespaces/queues@2021-11-01' = {
  name: nutritionQueueName
  parent: serviceBus
}

resource nutritionQueueSetting 'Microsoft.AppConfiguration/configurationStores/keyValues@2022-05-01' = {
  parent: appConfig
  name: 'HealthCheckr:NutritionQueueName'
  properties: {
    value: nutritionQueue.name
    tags: tags
  }
}
